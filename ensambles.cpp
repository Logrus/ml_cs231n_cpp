...
int main(){
    ...
    std::vector<std::string> names = {
       "../CIFAR10/data_batch_1.bin",
       "../CIFAR10/data_batch_2.bin",
       "../CIFAR10/data_batch_3.bin",
       "../CIFAR10/data_batch_4.bin",
    ...
    for(int i=0; i<testset.images_.size(); ++i){
       int label = net1.inference(testset.images_[i]);
    ...
    total = 0;
    for(int i=0; i<testset.images_.size(); ++i){
       int label = net2.inference(testset.images_[i]);
       if(label == testset.labels_[i]) correct++;
       total++;
    }
    ...
    total = 0;
    for(int i=0; i<testset.images_.size(); ++i){
       int label = net3.inference(testset.images_[i]);
       if(label == testset.labels_[i]) correct++;
       total++;
    }
    ...
    total = 0;
    for(int i=0; i<testset.images_.size(); ++i){
       int label = net4.inference(testset.images_[i]);
       if(label == testset.labels_[i]) correct++;
       total++;
    }
    ...
    total = 0;
    for(int i=0; i<testset.images_.size(); ++i){
       int label = ens.inference(testset.images_[i]);
       if(label == testset.labels_[i]) correct++;
       total++;
    }
