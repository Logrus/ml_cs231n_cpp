...
int main(){
    ...
    const std::vector< std::vector<float> > W1 = {
        { 0.17640523,  0.04001572,  0.0978738 ,  0.22408932,  0.1867558 , -0.09772779, 0.09500884, -0.01513572, -0.01032189,  0.04105985},
        { 0.01440436,  0.14542735,  0.07610377,  0.0121675 ,  0.04438632,  0.03336743, 0.14940791, -0.02051583,  0.03130677, -0.08540957},
        {-0.25529898,  0.06536186,  0.08644362, -0.0742165 ,  0.22697546, -0.14543657, 0.00457585, -0.01871839,  0.15327792,  0.14693588},
        { 0.01549474,  0.03781625, -0.08877857, -0.19807965, -0.03479121,  0.0156349 , 0.12302907,  0.12023798, -0.03873268, -0.03023028}
    };
    ...
    const std::vector< std::vector<float> > dW1 = {
        {-9.68499043e-02,   4.00157208e-03,  -2.05517828e-01,   1.87986352e-01,  1.60531645e-01,  -9.77277880e-03, 9.50088418e-03,   2.68884345e-03, -3.01022811e-02,-5.67802801e-03},
        { 4.45595008e-02,   1.45427351e-02,   6.95515502e-01,  -2.88616327e-01, -2.66986989e-01,   3.33674327e-03, 1.49407907e-02,   1.93435586e-02, -6.54700997e-02,-5.32928651e-01},
        { 1.16977821e-02,   6.53618595e-03,  -2.31623550e-01,  -6.26390355e-02, -1.41638971e-03,  -1.45436567e-02, 4.57585173e-04,  -2.90067077e-03,  5.35668029e-01, 3.69731998e-01},
        { 7.71766403e-02,   3.78162520e-03,  -3.13778323e-01,   2.26868568e-01,  2.06678709e-01,   1.56348969e-03, 1.23029068e-02,  -2.18055786e-03, -6.78943040e-01, 9.85573015e-02}
    };

    const std::vector< std::vector<float> > dW2 = {
    ...
    const std::vector<float> db1 = { -0.0070484, 0., 0.00310494, -0.0072399, -0.00573377, 0., 0., -0.0024372, 0.04121605, 0.02236176};
    ...
    const std::vector<int> batch_idx = {0, 1, 2, 3, 4};
